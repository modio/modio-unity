...
namespace Modio.API
{
    public static partial class ModioAPI
    {
        ...
        {
            /// <summary>
            /// <p>Browse users following the authenticated user.</p>
            ...
            internal static async Task<(Error error, JToken userObjects)> GetUserFollowersAsJToken(
            GetUserFollowersFilter filter
            ) {
                if (!IsInitialized()) return (new Error(ErrorCode.API_NOT_INITIALIZED), null);

                using var request = ModioAPIRequest.New($"/me/followers", ModioAPIRequestMethod.Get, ModioAPIRequestContentType.FormUrlEncoded);
            ...
            /// </summary>
            /// <param name="filter">Filter to apply to the request.</param>
            internal static async Task<(Error error, Pagination<UserObject[]>? userObjects)> GetUserFollowers(
            GetUserFollowersFilter filter
            ) {
                if (!IsInitialized()) return (new Error(ErrorCode.API_NOT_INITIALIZED), null);
...
#region Filter
            ...
            public static GetUserFollowersFilter FilterGetUserFollowers(
                int pageIndex = 0,
                int pageSize = 100
            ) 
            => new GetUserFollowersFilter(
                pageIndex, 
                pageSize
            );
            
            /// <summary>
            /// Filter for GetUserFollowers, see <see cref="Followers.FilterGetUserFollowers"/>
            /// to construct this filter <br/>
            /// Filtering options:<br/>
            /// </summary>
            public class GetUserFollowersFilter : SearchFilter<GetUserFollowersFilter>
            {
                internal GetUserFollowersFilter(
                    int pageIndex,
                    int pageSize
