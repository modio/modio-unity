...
namespace Modio.API
{
    public static partial class ModioAPI
    {
        ...
        {
            /// <summary>Get all games. Successful request will return an array of [Game Objects](#get-games-2). We recommended reading the [filtering documentation](#filtering) to return only the records you want.</summary>
            /// <param name="filter">Filter to apply to the request.</param>
            internal static async Task<(Error error, JToken gameObjects)> GetGamesAsJToken(
            GetGamesFilter filter
            ) {
                if (!IsInitialized()) return (new Error(ErrorCode.API_NOT_INITIALIZED), null);

                using var request = ModioAPIRequest.New($"/games", ModioAPIRequestMethod.Get);
            ...
            /// <summary>Get all games. Successful request will return an array of [Game Objects](#get-games-2). We recommended reading the [filtering documentation](#filtering) to return only the records you want.</summary>
            /// <param name="filter">Filter to apply to the request.</param>
            internal static async Task<(Error error, Pagination<GameObject[]>? gameObjects)> GetGames(
            GetGamesFilter filter
            ) {
                if (!IsInitialized()) return (new Error(ErrorCode.API_NOT_INITIALIZED), null);
...
#region Filter
            ...
            public static GetGamesFilter FilterGetGames(
                int pageIndex = 0,
                int pageSize = 100
            ) 
            => new GetGamesFilter(
            ...
            public class GetGamesFilter : SearchFilter<GetGamesFilter>
            {
                ...
                /// <param name="status">Status of the game (only admins can filter by this field, see [status and visibility](#status-amp-visibility) for details):<br/><br/>__0__ = Not accepted<br/>__1__ = Accepted _(default)_<br/>__3__ = Deleted</param>
                /// <param name="condition"><see cref="Filtering"/></param>
                ...
                /// <param name="status">An ICollection of Status of the game (only admins can filter by this field, see [status and visibility](#status-amp-visibility) for details):<br/><br/>__0__ = Not accepted<br/>__1__ = Accepted _(default)_<br/>__3__ = Deleted</param>
                /// <param name="condition"><see cref="Filtering"/></param>
                ...
                /// <param name="curationOption">An ICollection of Curation option enabled by this game to approve mods:<br/><br/>__0__ = No curation: Mods are immediately available to play<br/>__1__ = Price change approval: Pricing changes for marketplace mods queued for acceptance<br/>__2__ = Full curation: All mods must be accepted by someone to be listed</param>
                /// <param name="condition"><see cref="Filtering"/></param>
