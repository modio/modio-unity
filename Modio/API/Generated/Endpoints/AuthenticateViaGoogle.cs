...
namespace Modio.API
{
    public static partial class ModioAPI
    {
        public static partial class Authentication
        {
            ...
            /// </summary>
            internal static async Task<(Error error, JToken accessTokenObject)> AuthenticateViaGoogleAsJToken(
            ...
            internal static async Task<(Error error, AccessTokenObject? accessTokenObject)> AuthenticateViaGoogle(
                GoogleAuthenticationRequest? body = null
            ) {
                if (!IsInitialized()) return (new Error(ErrorCode.API_NOT_INITIALIZED), null);
