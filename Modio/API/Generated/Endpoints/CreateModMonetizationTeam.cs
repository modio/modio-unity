    ...
    public static partial class ModioAPI
    {
        public static partial class Monetization
        {
            ...
            internal static async Task<(Error error, JToken monetizationTeamAccountsObject)> CreateModMonetizationTeamAsJToken(
                long modId,
                CreateModMonetizationTeamRequest body
            ) {
                if (!IsInitialized()) return (new Error(ErrorCode.API_NOT_INITIALIZED), null);

                using var request = ModioAPIRequest.New($"/games/{{game-id}}/mods/{modId}/monetization/team", ModioAPIRequestMethod.Post, ModioAPIRequestContentType.FormUrlEncoded);
