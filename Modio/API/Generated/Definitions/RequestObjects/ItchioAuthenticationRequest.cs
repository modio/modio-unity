...
namespace Modio.API.SchemaDefinitions{
    [JsonObject]
    internal readonly partial struct ItchioAuthenticationRequest : IApiRequest
    {
        ...
        /// <param name="itchioToken"></param>
        /// <param name="termsAgreed"></param>
        /// <param name="email"></param>
        /// <param name="dateExpires"></param>
        [JsonConstructor]
        public ItchioAuthenticationRequest(
            string itchio_token,
            bool terms_agreed,
            string email,
            long date_expires
        ) {
            ItchioToken = itchio_token;
