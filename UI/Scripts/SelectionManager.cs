...
namespace ModIOBrowser
{
    class SelectionManager : SelfInstancingMonoSingleton<SelectionManager>
    {
        ...
        //TODO! Get rid of this setting and hardcode it. Having this set on a prefab only adds to prefab vulnerability.
        ...
        public void Update()
        {
            ...
            {
                InputNavigation.Instance.SelectGameObject(CurrentViewHistory().Last());
            }
        }
        ...
        public void SelectMostRecentStillActivatedUiItem(bool force = false)
        {
            if(EventSystem.current.currentSelectedGameObject == null || force)
            {
                ...
                InputNavigation.Instance.SelectGameObject(item);
            }
        }
        ...
        public void SelectView(UiViews view)
        {
            ...
            if(revertToDefaultSelection)
            {
                ...
                InputNavigation.Instance.SelectGameObject(defaultObject);
